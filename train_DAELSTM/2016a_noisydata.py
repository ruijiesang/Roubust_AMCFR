...
def main(cfgs,c,t):
    ...
    path = './results_12.14/' + cfgs.method + '/' + cfgs.dataset + '/'  + cfgs.params["loss"]+'/' + str(c) +'c'+'_'+str(t)+'t'
    ...
    path_test = './results_12.14/' + cfgs.method + '/' + cfgs.dataset + '/' + cfgs.params["loss"]
...
if __name__ == '__main__':
    c = [2, 3, 4, 5, 6, 8, 10,11]
    t = [0.00001, 0.000005, 0.000001, 0.0000005, 0.0000001, 0.00000005, 0.00000001]
    best_acc=0
    for c1 in c:
        for t1 in t:
            cfgs = get_cfgs_noisydata()
            main(cfgs,c1,t1)
