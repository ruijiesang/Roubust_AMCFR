...
class ResNet(nn.Module):
    def __init__(self, classes):
        ...
        self.fc3 = nn.Sequential(nn.Linear(64, 32), nn.SELU(), nn.Dropout(0.3))
        self.fc4 = nn.Sequential(nn.Linear(32, 32), nn.SELU(), nn.Dropout(0.3))
        self.fc5 = nn.Sequential(nn.Linear(32, classes))
        self.init_weights()
...
def test():
    ...
    flops, params = thop.profile(net, inputs=(data_input,))
